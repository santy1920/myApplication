...
<form:form method="post" action="add_employee" modelAttribute="employee" onsubmit="return Formvalidation()">
...
<form:hidden path="active" value="1"/> 
        ...
        <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
            ...
            <form:input type="text" class="form-control" path="role" minlength="1" maxlength="20" placeholder="Role" required="required"/>
        </div>
        ...
        <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
            ...
            <form:input type="Number" class="form-control" path="salary" min="1" max="1000000" placeholder="Salary" required="required"/>
        </div>
   
        <div class="clearfix"></div>
        <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
            <form:label path="dob">Date of Birth(DD/MM/YYYY)</form:label>
            <form:input type="text" class="form-control" path="dob" placeholder="Date Of Birth" required="required"/>
        </div>
