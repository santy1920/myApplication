...
public final class HibernateUtil {
    ...
    private HibernateUtil() throws EMException {
        try {
     ...
     *
     */
    public static SessionFactory getFactory() throws EMException {
        try {
            if (null == factory) {
                factory = new Configuration().configure
                    ("hibernate.cfg.xml").
     ...
     *
     */
    public static void close(Session session) throws EMException {
        try {
            if(null != session) {
                session.close();
            }
